...
struct TranslatableStrings {
    ...
    static let Consent = NSLocalizedString("Please No Alliums helps you to assess whether a food product contains any allium. The assesment is based on the data of Open Food Facts and the allium free community. Producers however do change recipes before we catch them. So be VERY CAREFUL. If your are alergic do NOT trust Please No Alliums.", comment: "Text to explain the risks.")
